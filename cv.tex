...
\begin{tabular}{rl}
    ...
    \textsc{website:} & \href{http://cnatoli.com}{http://cnatoli.com}\\
...
\section{Education}
\begin{tabular}{rl}	
\textsc{Current} & Bachelor of \textsc{Information Technology (Hons)} at \textbf{The University of Sydney} \\
& Major: \emph{Computer Science}\\
& Expected Graduation: \textbf{2017}\\
&\\ 
&\\
...
\begin{tabular}{rl}
Strengths: & Java, JavaScript, HTML5, CSS, SQL, C\\
Experience: & Python, C++, Linux/Unix, BASH, Haskell
\end{tabular}
